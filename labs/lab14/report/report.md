...
Код из теории находится в файле pdf к лабораторной работе.

# Выполнение лабораторной работы

Все пояснения описаны внутри кода в виде комментариев на скриншотах.

![client.cpp](image/client.png){#fig:001 width=70%}

![server.cpp](image/server.png){#fig:001 width=70%}
